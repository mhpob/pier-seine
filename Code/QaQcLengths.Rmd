...
#h1<-ggplot(data=a.ss, aes(x=wk, y=counts, fill = length, color = length,order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +geom_bar(stat="identity")+ ggtitle("Length by week") #+ facet_grid(YOY ~ .)
#ggplotly(h1,tooltip = "text")

h1<-ggplot(data=a.ss  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 
ggplotly(h1,tooltip = "text")

m1<-ggplot(data=a.ss  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
...
h2<-ggplot(data=need  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h2,tooltip = "text")

m2<-ggplot(data=need  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h3<-ggplot(data=crab  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h3,tooltip = "text")

m3<-ggplot(data=crab  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h4<-ggplot(data=spot  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h4,tooltip = "text")

m4<-ggplot(data=spot  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h5<-ggplot(data=inland  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h5,tooltip = "text")

m5<-ggplot(data=inland  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h6<-ggplot(data=bass  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h6,tooltip = "text")

m6<-ggplot(data=bass  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h7<-ggplot(data=blue  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h7,tooltip = "text")

m7<-ggplot(data=blue  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h8<-ggplot(data=ancho  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h8,tooltip = "text")

m8<-ggplot(data=ancho  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h9<-ggplot(data=men  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h9,tooltip = "text")

m9<-ggplot(data=men  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h10<-ggplot(data=shad  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h10,tooltip = "text")

m10<-ggplot(data=shad  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
...
h11<-ggplot(data=perch  %>% filter(YOY == "YOY"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("YOY, Length by week") 

ggplotly(h11,tooltip = "text")

m11<-ggplot(data=perch  %>% filter(YOY == "1+"), aes(x=wk, y=counts, order = reorder(length2, -length), text = paste("Week:", wk,"Length:", length), show.legend=T)) +
  geom_bar(stat="identity", aes(fill = length, color = length))+ ggtitle("1+, Length by week") 
